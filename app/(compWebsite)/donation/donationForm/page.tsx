...
export default function ContactPage() {
  ...
  return (
    <>
      {isMobile ? (
        <>
          <div className="min-h-screen bg-gradient-to-b p-4 sm:p-6 md:p-8">
            <div className="grid grid-cols-12 gap-6 md:gap-8">
              ...
              {/* Centered Text Box - Responsive positioning */}
              <div
      ...
      w-full max-w-4xl"
              ...
              {/* Donation Form - Full width but with max-width constraint */}
