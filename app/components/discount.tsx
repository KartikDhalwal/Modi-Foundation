...
const Discount = () => {
  ...
  const nodes = [
    ...
    {
      id: "2",
      data: { label: "Request Additional Discount" },
    ...
    {
      id: "9",
      data: { label: "Model Wise Dashboard" },
    ...
    {
      id: "10",
      data: { label: "Variant Wise Dashboard" },
    ...
    {
      id: "11",
      data: { label: "Graphical Representation " },
