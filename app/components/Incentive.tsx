...
const Incentive = () => {
  ...
  const nodes = [
    ...
    {
      id: "4",
      data: { label: "Incentive Calculation" },
    ...
    {
      id: "5",
      data: { label: "Single Click Calculation " },
