...
const MGAApprovalFlow = () => {
  ...
  const nodes = [
    ...
    {
      id: "9",
      data: { label: "Driver View Section" },
      position: { x: -50, y: 660 },
      style: {
        background: colors[9],
        color: "#fff",
