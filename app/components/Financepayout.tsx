...
const Financepayout = () => {
  ...
  const nodes = [
    ...
    {
      id: "2",
      data: { label: "New Car Pending Data" },
    ...
    {
      id: "4",
      data: { label: "Payout Pending Data" },
    ...
    {
      id: "8",
      data: { label: "Payout Payment Received" },
