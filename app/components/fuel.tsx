...
const fuel = () => {
  ...
  const nodes = [
    {
      id: "1",
      data: { label: "Fuel Management Process" },
    ...
    {
      id: "2",
      data: { label: "Fuel Slip Generation For New Car Delivery" },
    ...
    {
      id: "3",
      data: { label: "Fuel Slip Generation For Demo Car Test Drive" },
      position: {  x:300, y: -50 },
      style: {
        background: colors[4],
        color: "#fff",
    ...
    {
      id: "4",
      data: { label: "Fuel Slip Generation For Inter Branch Transfer" },
