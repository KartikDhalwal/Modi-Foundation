...
const dailycashupdation = () => {
  ...
  const nodes = [
    {
      id: "1",
      data: { label: "Daily Cash Updation By Cashier" },
    ...
    {
      id: "6",
      data: { label: "Automatic Email Send to CEO" },
...
export default dailycashupdation;
